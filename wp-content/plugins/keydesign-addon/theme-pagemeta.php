...
// Adds meta boxes to the main column on the Page edit screens.
	function themetek_add_meta_box() {
		...
		foreach ( $screens as $screen ) {
			...
			add_meta_box(
				'themetek_pagetitle',
				esc_html__( 'Page Title', 'intact' ), 'themetek_meta_box_pagetitle', $screen );
			...
			esc_html__( 'Page Template', 'intact' ), 'themetek_meta_box_portfolio_templates', 'portfolio', 'side', 'default');
			...
			esc_html__( 'Page Settings', 'intact' ), 'themetek_meta_box_portfolio_settings', 'portfolio', 'normal', 'default');
	}
