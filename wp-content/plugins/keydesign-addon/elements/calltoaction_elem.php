                ...
                vc_map(array(
                    ...
                    "params" => array(
                        ...
                        array(
                            ...
                            "value" => "",
                            "description" => esc_html__("Enter the box title here.", "keydesign")
                        ),
                        array(
                            "type" => "colorpicker",
                            "class" => "",
                            ...
                            "value" => "",
                            "description" => esc_html__("Select the title color.", "keydesign")
                        ),
                        array(
                            "type" => "textfield",
                            "class" => "",
                        ...
                        array(
                            ...
                            "value" => "",
                            "description" => esc_html__("Select the subtitle color.", "keydesign")
                        ),
                        array(
                            "type" => "colorpicker",
                            "class" => "",
