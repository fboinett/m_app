                ...
                vc_map(array(
                    ...
                    "params" => array(
                        ...
                        array(
                            "type" => "colorpicker",
                            "class" => "",
                            "heading" => esc_html__("Percent value color", "keydesign"),
                            "param_name" => "pc_percent_color",
                            "value" => "",
                            "dependency" => array(
              								"element" => "pc_center_content",
              								"value" => "percent_value",
              							),
                            "description" => esc_html__("Choose percent text color. If none selected, the default theme color will be used.", "keydesign"),
                        ),
        ...
        public function kd_piechart_shrt($atts, $content = null)
        {
            ...
            $output .= '<div class="kd_pie_chart '.$css_animation.' '.$pc_extra_class.'" '.$animation_delay.'>';
              $output .='<span class="kd_chart" data-bar-color="'.$pc_main_color.'" '.(!empty($pc_track_color) ? 'data-track-color="'.$pc_track_color.'"' : '').' data-line-width="'.$bar_width.'" data-percent="'.$pc_value.'">';
                    ...
                    $output .='<span class="pc_percent_container" '.(!empty($pc_percent_color) ? 'style="color: '.$pc_percent_color.';"' : '').'><span class="pc_percent"></span>%</span>';
