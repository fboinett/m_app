    ...
    class KD_ELEM_MAP extends KEYDESIGN_ADDON_CLASS {
        ...
        public function kd_map_shrt($atts, $content = null) {
            ...
            $output .= '<div class="kd-alertbox kd-contact-alertbox ab_info">
                        ...
                        <p>Google maps requires a valid API key in order to work.<br> You can add it in Appearance > Theme Options > Global Options.<br> You can generate a new API key from https://developers.google.com/maps</p></div>
